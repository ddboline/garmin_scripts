...
### These are hacks -- just replaces sport label / calorie calculation, could do this after reading file into memory?
list_of_biking_files = ['20101120T135534.gmn', '20110507T144308.gmn', '20110829T171218.gmn', '20111220T134356.gmn', '20120614T061809.gmn']
list_of_running_files = ['20100816T175612.gmn', '20100825T165244.gmn', '20101031T145551.gmn', '20110524T171336.gmn', '20110627T161529.gmn', '20120504T172702.gmn']
list_of_walking_files = ['20120428T112809.gmn', '20120519T103538.gmn', '20120519T104029.gmn', '20121231T154005.gmn']
list_of_stair_files = ['20120208T204305.gmn']
...
def is_biking_file(string):
    ...
    for f in list_of_biking_files:
        if f in string:
            return True
    return False

def is_running_file(string):
    ''' convenience function '''
    for f in list_of_running_files:
        if f in string:
            return True
    return False

def is_walking_file(string):
    ''' convenience function '''
    for f in list_of_walking_files:
        if f in string:
            return True
    return False

def is_stair_file(string):
    ''' convenience function '''
    for f in list_of_stair_files:
        if f in string:
            return True
    return False
...
list_of_corrected_laps = {
     ...
     '2015-01-15T12:27:59Z': {0: 5/1.609},
